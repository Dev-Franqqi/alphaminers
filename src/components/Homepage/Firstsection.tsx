...
export default function() {
  return (
    ...
    <p className="mb-5 text-lg font-semibold">We are committed to providing all our investors with exceptional service while offering our team the best training</p>
